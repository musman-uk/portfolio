...
- **Bash and Git CLI** – allows me direct control of repository management, running commands and
  troubleshooting.
- **GitHub Copilot** – assists across GitHub workflows by identifying errors, suggesting fixes,
...
- **GitHub Pages** – hosts live demos of selected projects, making them accessible directly from
  the browser.
